...
class HBNBCommand(cmd.Cmd):
    ...
    def precmd(self, line):
        """ The Reformat command line for advanced command syntax.
    ...
    def postcmd(self, stop, line):
        """The Prints if isatty is false"""
        if not sys.__stdin__.isatty():
            print('(hbnb) ', end='')
        return stop

    def do_quit(self, command):
        """this  Method to exit the HBNB console"""
        exit()

    def help_quit(self):
        """ this prints Prints the help documentation for quit  """
    ...
    def help_show(self):
        """ This Help information for the show command """
